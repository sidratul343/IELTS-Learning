...
<?php include 'navhome.php'; ?>
    <div class="wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="mt-4 mb-2">Writing example</h2>
                    ...
                    <div class="form-group">
                        ...
                        <img src="<?php echo $data['images']; ?>" height="200" width="200" class="img-thumnail"/>
                    </div>
                    ...
                    <p><a href="writing.php" class="btn btn-secondary">Back</a></p>
                </div>
            </div>        
        </div>
    </div>
