                ...
                <div class="col-md-12">
                    ...
                    if($result = mysqli_query($link, $sql)){
                        if(mysqli_num_rows($result) > 0){
                            ...
                            align="center" style="margin: 0px auto;">';
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            echo '<a href="read_write.php?id='. $row['id'] .'"  title="View examples" data-toggle="tooltip"><span class="fa fa-eye  fa-lg "></span></a>';
                            ...
                            echo '<div class="alert alert-danger"><em>No examples were found.</em></div>';
                        }
                    } else{
